...
OpenGL_Apprentissage.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) OpenGL_Apprentissage.pch et un fichier de type précompilé nommé StdAfx.obj.
